...
export const api = {
  ...
  removeQuarantineFlag: (appPath) => invoke('remove_quarantine_flag', { appPath }),
  removeQuarantineWithSudo: (appPath, password) => invoke('remove_quarantine_with_sudo', { appPath, password }),
  executeCommand: (command, args) => invoke('execute_command', { command, args }),
